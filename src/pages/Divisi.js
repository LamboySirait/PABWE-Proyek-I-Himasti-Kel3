      ...
      <Container className="mt-4">
        <NavLink href="/kominfo">
          <Row
            ...
            style={{ backgroundColor: "#1c323d", borderRadius: "20px" }}
          >
            <Col md={7} xs={6}>
              <div className="d-flex">
                ...
                >
                  ...
                  <p className="mt-3">
                    ...
                    dan berbagai acara yang diadakan oleh Himpunan Mahasiswa
                    Prodi (HIMAPRO)
                  </p>
                </div>
              </div>
              ...
              <div className="d-flex">
                ...
                >
                  ...
                  <p className="mt-3">
                    ...
                    dibutuhkan oleh himpunan untuk merealisasikan seluruh
                    kegiatan ataupun program kerja yang dimiliki himpunan.
                  </p>
                </div>
              </div>
            </Col>
            ...
            <Col md={{ span: 7, offset: 5 }}>
              <div className="d-flex">
                ...
                >
                  ...
                  <p className="mt-3">
                    Menjadikan HIMASTI sebagai tempat untuk berekspresi di
                    bidang seni dan juga sebagai wadah aspirasi serta minat
                    mahasiswa
                  </p>
                </div>
                <img
