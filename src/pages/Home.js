        ...
        <div style={{marginTop: '75px'}}>
            <div>
                <Carousel className='justify-content-center m-auto' style={{height: '90vh'}}>
                    <CarouselItem style={{height: '90vh', backgroundImage: `url(${Tanoto})`, opacity: '50%'}}>
                        <h1>SYALALALALALA</h1>
                    </CarouselItem> 
                    <CarouselItem style={{height: '90vh', backgroundImage: `url(${Gambar})`, backgroundSize: '1600px 90vh', opacity: '50%'}}>
            ...
            <div className='d-flex'>
                <div className='mt-5 m-auto' style={{width: '1300px'}}>
                    <h1 className='text-white'  data-aos='fade-up'>Tentang Himasti</h1>
                    <div className='d-flex m-5' data-aos='fade-up'>
                        <img className='m-lg-3' src={Logo} alt="" width='300px'/>
                        <div className='text-white m-lg-3 d-flex'  style={{alignItems: 'center', backgroundImage: {Tanoto}}}>
                            <p>"Program Studi S1 Teknik Informatika merupakan salah satu dari 4 (empat) program studi di bawah Fakultas Teknik Informatika dan Elektro di Institut Teknologi Del."</p>
                        </div>
                    </div>
                    <div className='d-flex m-5 text-white' data-aos='fade-up'>
                        <h1 className='m-lg-5' style={{fontSize: '100px'}}>Visi</h1>
                        <p className='m-lg-5'>Menjadi program Teknik Informatika yang unggul yang berperan dalam menghasilkan dan memanfaatkan teknologi untuk mengembangkan potensi lokal bagi kemajuan bangsa pada tahun 2023.</p>
                    </div>
                    <div className='d-flex m-5 text-white text-start' data-aos='fade-up'>
                        ...
                        <h1 className='m-lg-5' style={{fontSize: '100px'}}>Misi</h1>
                    </div>
                </div>
            </div>
            ...
            <div className='d-flex' data-aos='fade-up'>
                <div className='text-white mt-5 m-auto border' style={{width: '1300px'}}>
                    <h1 className='text-start'>Berita</h1>
                            ...
                            <SwiperSlide style={{width: 'auto'}}>
                                <Card className='text-dark'>
                                    ...
                                    <Card.Body>
                                        ...
                                        <Card.Text>
                                            Syalalalalallalla lalal alala lah
                                        </Card.Text>
                                    </Card.Body>
                                    <Card.Footer>
            ...
            <div className='d-flex'>
                <div className='border m-auto'  style={{height: '500px', width: '1300px'}}>
